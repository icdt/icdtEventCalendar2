        ...
        calendar: {
            ...
            dayClick: function (date, allDay, jsEvent, view) {
                ...
                if (typeof($scope.title) == 'undefined' ||
                    typeof($scope.doc) == 'undefined' ||
                    typeof($scope.start) == 'undefined' ||
                ...
                // 不知為何存進去localStorage時，最後一筆會沒有_id，晚點儲存可解
                $timeout(function () {
                    localStorage['events'] = JSON.stringify($scope.events);
                }, 1000);
...
//app.controller('CalendarCtrl', ['$scope', '$compile', 'uiCalendarConfig', function ($scope, $compile, uiCalendarConfig) {
